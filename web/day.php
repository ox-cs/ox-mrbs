...
else
{
  ...
  // Show current date
  echo "<h2 id=\"dwm\">";
  echo utf8_strftime("%A %d %B %Y", $am7);
...
<div class=\"screenonly\">
  ...
  if ($times_along_top)
  {
	...
	// ENC: add room to the booking string
	$query_strings['booking']     = "area=$area&amp;room=$room_id&amp;day=$day&amp;month=$month&amp;year=$year";
