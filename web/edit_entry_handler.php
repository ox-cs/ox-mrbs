<?php
// $Id: edit_entry_handler.php 1238 2009-11-03 14:25:31Z cimorrison $
    ...
    isset($rep_end_month) && isset($rep_end_day) && isset($rep_end_year))
{
  ...
  // ed: added is_dst:
  $rep_enddate = mktime($hour, $minute, 0, $rep_end_month, $rep_end_day, $rep_end_year, is_dst($rep_end_month, $rep_end_day ,$rep_end_year, $hour));
}
else
{
  $rep_type = 0;
